...
<x-card :result="$result->estudiante->nombre">
  <div class="col-5">
    ...
    <x-p-card :result="$result->created_at->format('j F, Y')" nameLabel="Fue prestado el" icono="" />
    <x-p-card :result="$result->updated_at->format('j F, Y')" nameLabel="Última modificación el" icono="" />
