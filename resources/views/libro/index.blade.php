  ...
  <div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
      ...
      <tbody>
        ...
        <!-- Detail Modal -->
          <div class="modal fade bd-example-modal-lg" id="modalDetail-{{$datos[0]->id}}" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">


                <div class="modal-header">
                  <div class="text-center"><p><strong>Título: {{ $datos[0]->titulo}}</strong></p></div>
                </div>
                <div class="modal-body">
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-4 titleDiv">ISBN</div>
                      <div class="col-md-4 titleDiv">ESTADO</div>
                      <div class="col-md-4 titleDiv">ACCIONES</div>
                      <?php 
                      for ($i=0; $i < count($datos); $i++) {?>

                      <div class="col-md-4">{{$datos[$i]->isbn}}</div>
                      <div class="col-md-4">
                        @if($datos[$i]->estado === 1)
                      ...
                      <div class="col-md-4">
                        ...
                        <button type="submit" class="btn btn-sm" data-toggle="modal" data-target="#modal-{{$datos[$i]->id}}">
                        ...
                        <a class="btn btn-success btn-sm" href="{{ route('prestamos'.'.create', ['query' => $datos[$i]->id])}}">Prestar</a>
